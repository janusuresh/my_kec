...
function deleteButton(staffId) {
    ...
    document.getElementById('caccept').addEventListener("click", () => {
        $.ajax({
            url : "PHP/PROFILE/deleteStaff.php",
            type : "post",
...
function editButton(staffId) {
    $.ajax({
        url : "PHP/PROFILE/editStaff.php",
        type : "post",
        data : {"staffId" : staffId},
        success : function(res) {
...
function adminFilter() {
    ...
    var select = document.getElementsByName('designation')[0];
    var designation = select.options[select.selectedIndex].value;
    ...
    $.ajax({
        url : "PHP/PROFILE/filterStaffDetail.php",
        type : "post",
        data : {"id" : 1, "department" : department, "section" : section, "semester" : semester, "designation" : designation},
        success : function(res) {
...
function hodFilter() {
    ...
    $.ajax({
        url : "PHP/PROFILE/filterStaffDetail.php",
        type : "post",
        data : {"id" : 1, "section" : section, "semester" : semester, "designation" : designation},
        success : function(res) {
            document.getElementsByClassName('detail-container1')[0].innerHTML = res;
            document.getElementsByClassName('detail-container')[0].style.display = "none";
            document.getElementsByClassName('detail-container1')[0].style.display = "block";
