...
<?php
    ...
    if(isset($_POST['rollNumber'])) {
        ...
        $sql = " SELECT * FROM SAP_" . $studentBatch ."Batch WHERE  studentRollNumber = '$rollNumber' AND stateOfProcess = '0';";
        $result = mysqli_query($link,$sql);
        if(mysqli_num_rows($result) > 0) {
            ...
            foreach($result as $student) {
                ...
                if($student['conductivityMode'] == 1) {
                    echo "<div class='card-blocks'>
                            <div class='points'style='background-color:rgb(255, 3, 192);'>" . $points . "</div>
                    ...
                    echo "<div class='card-blocks'>
                            <div class='points'style='background-color:rgb(0, 254, 110);'>" . $points . "</div>
                                <div class='document-submitted'> " . $divElement . " </div>
                                <button class='btn view-button' onclick = viewButton('" . $student['sapId'] . "','" . $rollNumber . "')>VIEW</button>
                            </div>";
                }
            ...
            echo "<div class='not-submitted'><i>Not yet document submitted.</i></div>";
        }
    }
