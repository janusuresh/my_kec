...
<?php
	...
	if(mysqli_num_rows($result) > 0 ) {
		foreach($result as $mark) {
			$expectedMark += $mark['expectedMark'];
		}
	}
            ...
            echo "<table class='table-responsive table-bordered'>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class='evaluation-details'>" . $expectedMark . "</td>
                ...
                echo "<br>";
                echo "<br>";
		echo '<button class="btn download-button" onclick = download("' . $rollNumber . '","' . $semester . '")>DOWNLOAD <i class="fa-solid fa-download"></i></button>';
