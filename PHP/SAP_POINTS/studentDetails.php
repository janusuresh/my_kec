		...
		<table>
			...
			<tr class='line'>
                    ...
                    <div class='detail-button-container'>
                        <button class='btn detail-button' onclick=getDetail('" . $student['rollNumber'] . "')>GET DETAILS</button>
                        <button class='btn document-button' onclick = openDocument()>OPEN DOCUMENT</button>
                    </div>
            </div>";
        }
    }
